...
public class GameManager : MonoBehaviour
{
    ...
    Level[] levels = {
        ...
        new Day(30, "L2", "You can skip day or text by pressing L."),
        new Night(20, "Wolves are faster at night.\nRemember, you can't move the sheeps when the night comes."),
        ...
        new Night(20, "You can use Left Shift to temporarily change the time to night"),
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.L) && levelIndex < levels.Length && levels[levelIndex].levelType != Level.LevelType.Night)
        {
            timer = 0;
        }
